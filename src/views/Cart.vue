  ...
  <div class="background">
    <div v-if="!cart.length" class="empty">
      ...
      <router-link to="/products"
        ><button>Find awesome stuff here!</button></router-link
      >
    </div>
        ...
        <div class="summary">
          ...
          <div class="section-five">
            ...
            <div class="icon-section">
              <img
                class="klarna"
                src="@/assets/checkout-icons/klarna-logo.svg"
                alt="klarna"
              />
              <img
                class="paypal"
                src="@/assets/checkout-icons/paypal-logo.svg"
                alt="paypal"
              />
              <img
                class="visa"
                src="@/assets/checkout-icons/Visa-logo.svg"
                alt="visa"
              />
              <img
                class="mastercard"
                src="@/assets/checkout-icons/mastercard-logo.svg"
                alt="mastercard"
              />
            </div>
          </div>
